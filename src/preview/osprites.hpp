...
public:
    ...
    SpriteSectionEntry currentSection;

    OSprites(HWSprites* hwsprites, QList<SpriteSectionEntry>* spriteSections, ORoad *oroad, RomLoader* rom);
	~OSprites(void);
	void init();
    void disable_sprites();
    void init_startline_sprites();
    void tick(int pos, const ControlPoint *cp);
    void update_sprites();
...
private:
    ...
    void sprite_control(int pos, const ControlPoint *cp);
